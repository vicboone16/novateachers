...
import { Users, Activity, FileText, ChevronDown, LogOut, Building2, Settings, GraduationCap, ClipboardList, Inbox, BookOpen, BarChart3, Bell, LayoutGrid, FileEdit, FileSearch, MessageCircle, MessagesSquare, Star, Monitor, UserCheck, Gamepad2, School, ShieldCheck, ShieldAlert, HelpCircle, Sparkles, Check } from 'lucide-react';
