...
-- Rename notification_preferences columns to role-neutral names
ALTER TABLE public.notification_preferences RENAME COLUMN teacher_log_reminders TO data_log_reminders;
ALTER TABLE public.notification_preferences RENAME COLUMN note_completion_reminders TO session_note_reminders;
ALTER TABLE public.notification_preferences RENAME COLUMN parent_messages TO caregiver_messages;

-- Drop and recreate the effective_user_reminders view with new column names
DROP VIEW IF EXISTS public.effective_user_reminders;
